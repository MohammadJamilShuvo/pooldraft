...
# ===============================
# Collembola Reference Genome Setup Script
# ===============================

# Set working directory
WORKDIR="/pfs/work9/workspace/scratch/fr_ms2252-collembola/entomobryo_project"
TOOLDIR="$WORKDIR/00_tools"
CONDA_DIR="$TOOLDIR/miniconda3"
...
conda create -n genome_env python=3.9 -y
conda activate genome_env

conda install -c bioconda -c conda-forge fastqc multiqc fastp trimmomatic megahit spades jellyfish genomescope2 quast busco bbmap kat bandage bwa samtools pilon repeatmodeler repeatmasker braker blast interproscan eggnog-mapper gffread blobtools freebayes gatk4 vcftools bcftools matplotlib pandas seaborn -y
